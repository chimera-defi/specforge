...
function buildCompetitiveAnalysis(document: DocumentRecord): string {
  ...
  return [
    ...
    "### Direct Competitors",
    "",
    "- Competitor 1: [Name] - Strength: [Description], Weakness: [Description]",
    "- Competitor 2: [Name] - Strength: [Description], Weakness: [Description]",
    "- Competitor 3: [Name] - Strength: [Description], Weakness: [Description]",
    "",
    "### Indirect Competitors",
    "",
    "- Indirect 1: [Name] - How they solve the problem differently",
    "- Indirect 2: [Name] - How they solve the problem differently",
    "",
    "## Competitive Advantages",
    "",
    "- **Technical Advantage**: [What technical advantage do you have?]",
    "- **UX Advantage**: [What UX advantage do you have?]",
    "- **Distribution Advantage**: [What distribution advantage do you have?]",
    "- **Cost Advantage**: [What cost advantage do you have?]",
    "- **Network Effect**: [Do you have network effects?]",
    "",
    "## Competitive Moat",
    "",
    "- **Brand**: [Brand strength and recognition]",
    "- **Technology**: [Proprietary technology or patents]",
    "- **Network Effects**: [User base that increases value]",
    "- **Switching Costs**: [Cost for users to switch to competitors]",
    "- **Data**: [Unique data assets]",
    "- **Ecosystem**: [Integrated ecosystem or partnerships]",
    "",
    "## Market Positioning",
    "",
    "- **Target Segment**: [Specific market segment you're targeting]",
    "- **Positioning Statement**: [How you want to be perceived]",
    "- **Pricing Position**: [Premium, mid-market, or value pricing]",
    "- **Differentiation Strategy**: [How you differentiate from competitors]",
    "",
    "## Threat Assessment",
    "",
    "- **New Entrants**: [Barrier to entry for new competitors]",
    "- **Substitute Products**: [Alternative solutions that could replace your product]",
    ...
    "",
    "- **Offensive Strategy**: [How will you gain market share?]",
    "- **Defensive Strategy**: [How will you protect your market position?]",
    "- **Partnership Strategy**: [Strategic partnerships to strengthen position]",
    "- **Innovation Strategy**: [How will you stay ahead of competitors?]",
  ].join("\n");
}
...
function buildBusinessModel(document: DocumentRecord): string {
  ...
  return [
    ...
    "### Value Propositions",
    "",
    "- **Core Value**: [What core value do you deliver?]",
    "- **Pain Points Solved**: [What pain points do you solve?]",
    "- **Gains Created**: [What gains do you create for customers?]",
    "",
    "### Customer Segments",
    "",
    "- **Primary Segment**: [Primary customer segment]",
    "- **Secondary Segments**: [Secondary customer segments]",
    "- **Customer Personas**: [Detailed customer personas]",
    "",
    "### Channels",
    "",
    "- **Primary Channels**: [How do you reach customers?]",
    "- **Secondary Channels**: [Additional channels]",
    "- **Channel Partners**: [Strategic channel partnerships]",
    "",
    "### Customer Relationships",
    "",
    "- **Relationship Type**: [Self-service, assisted, dedicated, etc.]",
    "- **Retention Strategy**: [How do you retain customers?]",
    "- **Support Model**: [What support do you provide?]",
    "",
    "### Revenue Streams",
    "",
    "- **Primary Revenue**: [Primary revenue source]",
    "- **Secondary Revenue**: [Secondary revenue sources]",
    "- **Pricing Model**: [Subscription, usage-based, one-time, freemium, etc.]",
    "- **Pricing Tiers**: [Pricing tiers and features]",
    "",
    "### Key Resources",
    "",
    "- **Physical Resources**: [Physical assets needed]",
    "- **Intellectual Resources**: [IP, patents, proprietary tech]",
    "- **Human Resources**: [Key team roles needed]",
    "- **Financial Resources**: [Capital requirements]",
    "",
    "### Key Activities",
    "",
    "- **Core Activities**: [Core business activities]",
    "- **Support Activities**: [Support activities needed]",
    "- **Partnership Activities**: [Partnership management]",
    "",
    "### Key Partners",
    "",
    "- **Strategic Partners**: [Key strategic partnerships]",
    "- **Supplier Partners**: [Key supplier relationships]",
    "- **Distribution Partners**: [Distribution channel partners]",
    "",
    "### Cost Structure",
    "",
    "- **Fixed Costs**: [Fixed cost items]",
    "- **Variable Costs**: [Variable cost items]",
    "- **Economies of Scale**: [Scale opportunities]",
    "- **Economies of Scope**: [Scope opportunities]",
    "",
    "## Pricing Strategy",
    "",
    "- **Pricing Philosophy**: [Value-based, cost-plus, competitive, etc.]",
    "- **Pricing Tiers**: [Detailed pricing tiers]",
    "- **Discount Strategy**: [Discount policies]",
    "- **Upsell/Cross-sell**: [Upsell and cross-sell opportunities]",
    "",
    ...
    "- **LTV:CAC Ratio**: [Target ratio, typically 3:1 or higher]",
    "- **Monthly Recurring Revenue (MRR)**: [Expected MRR per customer]",
    "- **Annual Recurring Revenue (ARR)**: [Expected ARR per customer]",
    "- **Churn Rate**: [Expected churn rate]",
    "- **Gross Margin**: [Expected gross margin]",
    "",
    "## Go-to-Market Strategy",
    "",
    "- **Initial Target Segment**: [First segment to target]",
    "- **Marketing Channels**: [Primary marketing channels]",
    "- **Sales Process**: [Sales process overview]",
    "- **Key Partnerships**: [Strategic partnerships for GTM]",
    "- **Launch Strategy**: [How will you launch?]",
    "- **Growth Strategy**: [How will you grow after launch?]",
    "",
    "## Revenue Milestones",
    "",
    "- **Month 1-3**: [Revenue targets for first quarter]",
    "- **Month 4-6**: [Revenue targets for second quarter]",
    "- **Month 7-12**: [Revenue targets for first year]",
    "- **Year 2-3**: [Revenue targets for years 2-3]",
    "",
    "## Business Risks",
    "",
    "- **Market Risk**: [Market-related risks]",
    "- **Product Risk**: [Product-related risks]",
    "- **Financial Risk**: [Financial-related risks]",
    "- **Operational Risk**: [Operational-related risks]",
    "- **Regulatory Risk**: [Regulatory-related risks]",
  ].join("\n");
}
